...
pub enum StakingError { 
    #[msg("Invalid time stamp attribute")]
    InvalidTimeStamp , 
    #[msg("Nft is already staked ")]
    AlreadyStacked, 
    #[msg("Nft is not stacke")]
    NotStacked, 
    #[msg("Stacking attributes are not initialized on this asset")]
    StakingNotInitialized , 
    #[msg("Attribute plugin is missing on this asset")]
